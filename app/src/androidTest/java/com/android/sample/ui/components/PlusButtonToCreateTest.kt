...
class PlusButtonToCreateTest {
    ...
    fun setUp() {
        ...
        composeTestRule.setContent {
            PlusButtonToCreate(navigationActions = mockNavigationActions)
        }
    }
    ...
    fun plusButtonToCreate_iconIsDisplayed() {
        composeTestRule.onNodeWithContentDescription(TopLevelDestinations.ADD_ACTIVITY.textId).assertIsDisplayed()
    }
}