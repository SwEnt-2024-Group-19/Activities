...
class CreateActivityScreenTest {
    ...
    private val mockLocationViewModel = mockk<LocationViewModel>()
    ...
    fun createActivityScreen_displaysTitleField() {
        composeTestRule.setContent {
            CreateActivityScreen(mockViewModel, mockNavigationActions, mockProfileViewModel, mockLocationViewModel)
        }
        composeTestRule
