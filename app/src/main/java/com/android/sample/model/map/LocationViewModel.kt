    ...
    constructor(
      ...
      fun setQuery(query: String) {
        ...
        /**
         * Starts tracking the user's location if permission is granted.
         * It calls `startLocationUpdates` from the repository, which continuously fetches location updates.
         */
