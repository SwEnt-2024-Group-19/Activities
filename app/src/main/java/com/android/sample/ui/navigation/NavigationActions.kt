...
object TopLevelDestinations {
    ...
    val ADD_ACTIVITY = TopLevelDestination(
        route = Route.ADD_ACTIVITY, icon = Icons.Outlined.AddCircleOutline, textId = "Add Activity"
    )
}

val LIST_TOP_LEVEL_DESTINATION = listOf(
    TopLevelDestinations.OVERVIEW, TopLevelDestinations.ADD_ACTIVITY, TopLevelDestinations.PROFILE
)
