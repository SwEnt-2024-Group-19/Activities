...
class ProfileViewModelTest {
    ...
    fun setUp() {
        ...
        profileViewModel = ProfileViewModel(userId = user.id, repository =  profilesRepository)
    }
    ...
    fun getActivitiesSuccessCallback() {
        ...
        // Using `eq` for specific values and `any` for generics where the actual instance doesn't matter for the test
        profileViewModel.fetchUserData(user.id)
